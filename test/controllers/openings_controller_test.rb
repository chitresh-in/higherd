...
class OpeningsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create opening" do
    assert_difference('Opening.count') do
      post openings_url, params: { opening: { ctc: @opening.ctc, deadline: @opening.deadline, location: @opening.location, profile: @opening.profile } }
    end
  ...
  test "should update opening" do
    patch opening_url(@opening), params: { opening: { ctc: @opening.ctc, deadline: @opening.deadline, location: @opening.location, profile: @opening.profile } }
